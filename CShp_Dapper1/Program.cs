...
namespace CShp_Dapper1
{
    public class Program
    {
        ...
        private static async void Deletar(string con)
        {
            int id = 2;
        ...
        private static async void Atualizar(string con)
        {
            using (var db = new SqlConnection(con))
            {
        ...
        private static async void Incluir(string con)
        {
            using (var db = new SqlConnection(con))
            {
                Cliente model = new Cliente();
        ...
        private static async void Consultar(string con)
        {
            using (var db = new SqlConnection(con))
            {
                await db.OpenAsync();
